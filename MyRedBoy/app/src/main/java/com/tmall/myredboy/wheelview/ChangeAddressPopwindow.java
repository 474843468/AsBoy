package com.tmall.myredboy.wheelview;
...
import com.tmall.myredboy.wheelview.adapter.AbstractWheelTextAdapter1;
...
public class ChangeAddressPopwindow extends PopupWindow implements View.OnClickListener {
    ...
    private String strProvince = "陕西";
    private String strCity     = "西安";
    private String strArea     = "雁塔区";
    ...
    public ChangeAddressPopwindow(final Context context) {
        ...
        //		this.setAnimationStyle(R.style.AnzimBottom);
    ...
    public void initCitys(String[] citys) {
        if (citys != null) {
            ...
            String[] city = mCitisDatasMap.get("陕西");
            arrCitys.clear();
    ...
    public void initAreas(String[] areas) {
        if (areas != null) {
            ...
            String[] area = mAreaDatasMap.get("西安");
            arrAreas.clear();
